...
my $genomefile = "$ENV{PROJECT_DIRECTORY}/../uri/statsig/harbison/70919/yeast_genome/cer_all-intergenic_Oct03";
my $param = "-l 13 -t 50 -L 50 -em 30 -s 123 -gibbsamp -p 0.05 -best_ent -markov 5 -ds -r 1 -print_runs -bfile $genomefile";
