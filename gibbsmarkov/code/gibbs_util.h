...
extern const char* scoreMetricToStr(enum ScoreMetric metric);
...
//----------------------------------------------------------------------
extern double*** buildValidBgscore(bool **isValidSite[SPAN_CAPACITY], double ***bgscore, int minspan, int maxspan, Dataset *data);
